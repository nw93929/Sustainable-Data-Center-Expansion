...
1. Sustainable Data Center Expansion Planning Tool
   Help city planners, local communities, and developers evaluate siting options for potential data centers via geospatial analysis of environment and consideration of energy consumption, emissions, water usage etc. through forecasting or simulating upkeep and map areas details like labor market, regulations on zoning, etc.
2. CoolSense Tool
